...
var retrieveRollbackMigrations = function (cloudMigrations, amount, atChildDbPath) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, files_1.retrieveAllMigrations)(atChildDbPath)];
            case 1:
...
var retrieveDiffCurrentTarget = function (currentMigration, targetMigration, atChildPath) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, from_migration_files_1.getLastMigrationSnippets)(atChildPath, currentMigration.timestamp)];
            case 1:
            ...
            case 2:
                ...
                diff = (0, diff_1.diffSnippets)(currentMigrations, targetMigrations);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, from_migration_files_1.getLastMigrationSnippets)(atChildPath, targetMigration.timestamp)
