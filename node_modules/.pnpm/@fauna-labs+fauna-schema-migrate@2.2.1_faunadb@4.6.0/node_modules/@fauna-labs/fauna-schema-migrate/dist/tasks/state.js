...
var apply = function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, frame_1, isLoading, migInfo, allCloudMigrationTimestamps, error_1, missingMigrDescription;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                isLoading = setInterval(function () {
                    frame_1 = (frame_1 + 1 === cliSpinners.dots.frames.length) ? 0 : frame_1 + 1;
                    std.write(cliSpinners.dots.frames[frame_1]);
                    rdl.cursorTo(std, 0, 0);
                }, cliSpinners.dots.interval);
                (0, shell_1.printMessage)(" Retrieving current cloud migration state \n");
                return [4 /*yield*/, (0, advance_1.retrieveMigrationInfo)(client)];
            case 2:
                migInfo = _a.sent();
                clearInterval(isLoading);
                allCloudMigrationTimestamps = migInfo.allCloudMigrations.map(function (e) { return e.timestamp; });
                (0, shell_1.printMessage)("\n\u2714 Retrieved current migration state", 'success');
                (0, shell_1.renderMigrationsMinmal)(allCloudMigrationTimestamps, migInfo.allLocalMigrations, 'state', 0);
                process.exit(0);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
