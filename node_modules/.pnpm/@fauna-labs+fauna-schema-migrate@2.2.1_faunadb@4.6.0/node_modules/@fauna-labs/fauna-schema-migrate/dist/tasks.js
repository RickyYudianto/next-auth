        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.runTask.apply(void 0, __spreadArray([task, task.name === 'run'], params, false))];
                case 1: return [2 /*return*/, _a.sent()];
                case 2: throw new Error("there is no task with name ".concat(name));
            }
        });
    });
};
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (task.name !== 'run' && !process.env.FAUNA_LEGACY) {
                        (0, shell_1.printMessage)("".concat(task.name, ": ").concat(task.description, " Executed..."), 'info');
                    }
                    return [4 /*yield*/, task.action.apply(task, params)];
                case 1:
                    result = _a.sent();
                    if (task.name !== 'run' && !process.env.FAUNA_LEGACY) {
                        (0, shell_1.printMessage)("".concat(task.name, ": ").concat(task.description, " Completed...\n"), 'success');
                    }
                    return [4 /*yield*/, (0, files_1.deleteTempDir)()];
                case 2:
                    _a.sent();
                    return [2 /*return*/, result];
                case 3:
                    error_1 = _a.sent();
                    (0, shell_1.printMessage)(error_1, 'error');
                    return [3 /*break*/, 4];
