    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [3 /*break*/, 7];
            case 1: return [4 /*yield*/, (0, exports.loadJsResource)(p)];
            case 2: return [2 /*return*/, _b.sent()];
            case 3: return [4 /*yield*/, (0, exports.loadTsResource)(p)];
            case 4: return [2 /*return*/, _b.sent()];
            case 5: return [4 /*yield*/, (0, exports.loadFqlResource)(p)];
            case 6: return [2 /*return*/, _b.sent()];
            case 7:
                console.error("unexpected extension ".concat(p));
                return [3 /*break*/, 8];
    ...
    return __generator(this, function (_l) {
        switch (_l.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, config_1.config.getTempDir()];
            case 3:
                filename = _f.apply(_e, _g.concat([_j.apply(_h, [_l.sent(), uniqueTempFolder]),
                    path_1.default.parse(p).base.replace('.ts', '.js')]));
...
var loadFqlResource = function (p) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, exports.loadApplicationFile)(p)];
            case 1:
                data = _a.sent();
                fql = (0, eval_1.evalFQLCode)(data);
                return [2 /*return*/, fql];
            case 2:
                err_3 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, retrieveAllPathsInPattern(fullPath, "**".concat(path_1.default.sep, "*.js"), ignoreChildDbs)];
                case 3:
                    jsResults = _a.sent();
                    return [4 /*yield*/, retrieveAllPathsInPattern(fullPath, "**".concat(path_1.default.sep, "*.ts"), ignoreChildDbs)];
                case 4:
                    tsResults = _a.sent();
                    return [4 /*yield*/, retrieveAllPathsInPattern(fullPath, "**".concat(path_1.default.sep, "*.fql"), ignoreChildDbs)];
                case 5:
                    fqlResults = _a.sent();
                    return [2 /*return*/, __spreadArray(__spreadArray(__spreadArray([], jsResults, true), tsResults, true), fqlResults, true)];
            }
        });
    });
};
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    resourcesDir = _a.sent();
                    fullPath = childDbPathToFullPath(resourcesDir, atChildDbPath, childDbsDir);
                    return [4 /*yield*/, (0, exports.retrieveAllResourceChildDbPaths)(fullPath, childDbsDir)];
                case 3:
                    paths = _a.sent();
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, retrieveAllPathsInPattern(path_1.default.join(fullPath, migrationFolder), "**".concat(path_1.default.sep, "*.js"), ignoreChildDbs)];
                                    case 1:
                                        jsResults = _a.sent();
                                        return [4 /*yield*/, retrieveAllPathsInPattern(path_1.default.join(fullPath, migrationFolder), "**".concat(path_1.default.sep, "*.ts"), ignoreChildDbs)];
                                    case 2:
                                        tsResults = _a.sent();
                                        return [4 /*yield*/, retrieveAllPathsInPattern(path_1.default.join(fullPath, migrationFolder), "**".concat(path_1.default.sep, "*.fql"), ignoreChildDbs)];
                                    case 3:
                                        fqlResults = _a.sent();
                                        return [2 /*return*/, {
                                                files: __spreadArray(__spreadArray(__spreadArray([], jsResults, true), tsResults, true), fqlResults, true),
                                                migration: migration,
                                            }];
                                }
                            });
...
var isDirectory = function (source) { return (0, fs_1.lstatSync)(source).isDirectory(); };
...
var getDirectories = function (source, ignoreChildDbs, childDbsDir) {
    if ((0, fs_1.existsSync)(source)) {
        return (0, fs_1.readdirSync)(source)
...
var retrieveAllPathsInPattern = function (basedir, pattern, ignoreChildDbs) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_r) {
        switch (_r.label) {
            ...
            case 2:
                _h = [
                    _f.apply(_e, _g.concat([_r.sent(), "**".concat(path_1.default.sep, "*")]))
                ];
...
var arrayToApplicationPath = function (filePath) {
    var fileFullPath = path_1.default.join.apply(path_1.default, __spreadArray([process.cwd()], filePath, false));
    return fileFullPath;
};
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, exports.writeNewMigrationDir)(atChildDbPath, time)];
            case 1:
                newMigrationDir_1 = _a.sent();
                migrations.forEach(function (mig) {
                    var _a;
                    mig.fqlFormatted = (0, print_1.prettyPrintExpr)(mig.fqlExpr);
                    var statement = expressions_1.StatementType[mig.statement];
                    fs_1.default.writeFileSync(path_1.default.join(newMigrationDir_1, "".concat(statement.toString().toLowerCase(), "-").concat((_a = mig.type) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase(), "-").concat(mig.name, ".fql")), mig.fqlFormatted);
                });
                _a.label = 2;
...
var childDbPathToFullPath = function (rootDir, atChildDbPath, childDbName, time) {
    ...
    if (atChildDbPath.length > 0) {
        ...
        return path_1.default.join.apply(path_1.default, __spreadArray(__spreadArray([rootDir], [].concat.apply([], fullPaths), false), [time], false));
    }
    else {
