...
var createStub = function (expr) {
    ...
    if (!expr.type) {
        ...
        throw new Error("Expression type undefined ".concat(expr));
    }
    else {
        var original = expr.fqlExpr.raw['create_' + (0, exports.camelToSnakeCase)(expr.type)].raw.object;
        var fqlFunction = resourceTypeToFqlCreateFunction(expr);
        var obj = { name: original.name };
        addRequiredProps(expr, obj);
        return (0, exports.toTaggedExpr)(expr, fqlFunction(obj), expressions_1.StatementType.Create);
    }
};
...
var transformUpdateToCreate = function (expr) {
    if (!expr.type) {
        ...
        obj1.name = expr.name;
        var fqlFunction = resourceTypeToFqlCreateFunction(expr);
        return (0, exports.toTaggedExpr)(expr, fqlFunction(obj1), expressions_1.StatementType.Create);
    }
};
...
var explicitelySetAllParameters = function (expr) {
    if (expr.statement !== expressions_1.StatementType.Update) {
        throw new Error("explicitelySetAllParameters is only meant for update expressions, received: ".concat(expr.statement));
    }
    ...
    switch (expr.type) {
        case resource_types_1.ResourceTypes.Collection:
            ...
            return (0, exports.toTaggedExpr)(expr, expr.fqlExpr, expressions_1.StatementType.Update);
        ...
        case resource_types_1.ResourceTypes.Database:
            ...
            return (0, exports.toTaggedExpr)(expr, expr.fqlExpr, expressions_1.StatementType.Update);
        default:
            throw new Error("Unknown type ".concat(expr.type));
    }
};
...
var transformCreateToUpdate = function (expr) {
    if (!expr.type) {
        ...
        return (0, exports.explicitelySetAllParameters)((0, exports.toTaggedExpr)(expr, Update(getReference(expr, resourceTypeToFqlReferenceFunction(expr)), expr.fqlExpr.raw['create_' + (0, exports.camelToSnakeCase)(expr.type)].raw.object), expressions_1.StatementType.Update));
    }
};
exports.transformCreateToUpdate = transformCreateToUpdate;
var transformCreateToDelete = function (expr) {
    return (0, exports.toTaggedExpr)(expr, Delete(getReference(expr, resourceTypeToFqlReferenceFunction(expr))), expressions_1.StatementType.Delete);
};
exports.transformCreateToDelete = transformCreateToDelete;
var transformUpdateToUpdate = function (expr) {
    return (0, exports.explicitelySetAllParameters)(expr);
};
...
var transformDbPathToCreate = function (childDbPath) {
    ...
    return (0, exports.transformDbNameToFqlGeneric)(name, db, expressions_1.StatementType.Create, createDbFql);
};
...
var transformDbPathToUpdate = function (childDbPath) {
    ...
    return (0, exports.transformDbNameToFqlGeneric)(name, db, expressions_1.StatementType.Update, updateDbFql);
};
...
var transformDbPathToDelete = function (childDbPath) {
    ...
    return (0, exports.transformDbNameToFqlGeneric)(name, db, expressions_1.StatementType.Delete, deleteDbFql);
};
...
var toTaggedExpr = function (taggedExpr, fqlExpr, statement) {
    if (taggedExpr === undefined) {
        ...
        var newExpr = {
            ...
            fql: fqlExpr.toFQL(),
            statement: statement,
            jsonData: (0, exports.getJsonData)(fqlExpr, type, statement),
            db: taggedExpr.db,
        };
        return newExpr;
    }
...
var getJsonData = function (fExpr, resourceType, statement) {
    ...
    if (statement === expressions_1.StatementType.Create) {
        var key = 'create_' + (0, exports.camelToSnakeCase)(resourceType);
        var jsonData = (0, lodash_clonedeep_1.default)(expr.raw[key].raw.object);
