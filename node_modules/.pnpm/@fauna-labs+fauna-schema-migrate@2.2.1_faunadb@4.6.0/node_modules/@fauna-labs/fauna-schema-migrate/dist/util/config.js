...
var Config = /** @class */ (function () {
    function Config() {
        ...
        this.defaultConfigString = "{\n            \"directories\": {\n                \"root\": \"".concat(defaults_1.default.directories.root, "\",\n                \"resources\": \"").concat(defaults_1.default.directories.resources, "\",\n                \"migrations\": \"").concat(defaults_1.default.directories.migrations, "\",\n                \"children\": \"").concat(defaults_1.default.directories.children, "\",\n                \"temp\": \"").concat(defaults_1.default.directories.temp, "\"\n            },\n            \"collection\": \"").concat(defaults_1.default.collection, "\"\n    }");
    }
    Config.prototype.configDefault = function () {
        return "module.exports = ".concat(this.defaultConfigString, " ");
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        if (!(0, fs_1.existsSync)(path_1.default.join(process.cwd(), defaults_1.default.configFile))) return [3 /*break*/, 5];
                        _a = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(0, fs_1.existsSync)(p)) return [3 /*break*/, 1];
