...
var planDatabaseMigrations = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, files_1.retrieveAllResourceChildDb)([])];
            case 1:
                allResourceChildDbs = _a.sent();
                return [4 /*yield*/, (0, from_migration_files_1.getAllLastDatabases)(null, false)
                    // They should be sorted according to the length of the child db path.
                ];
            case 2:
                allMigrationChildDbs = _a.sent();
                return [4 /*yield*/, (0, diff_1.retrieveDatabasesDiff)(allMigrationChildDbs, allResourceChildDbs)];
            case 3:
                dbDiff = _a.sent();
...
var planMigrations = function (atChildDbPath, extraDbExpr) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, from_resource_files_1.getResourceSnippets)(atChildDbPath)];
                case 1:
                    resources = _a.sent();
                    ...
                    return [4 /*yield*/, (0, from_migration_files_1.getLastMigrationSnippets)(atChildDbPath)
                ...
                case 2:
                    ...
                    // A diff between migrations means comparing the Resources that exist with
                    // the last seen migration of a certain resource.
                    return [2 /*return*/, (0, diff_1.diffSnippets)(migrations, resources)];
            }
        });
    });
};
...
var findIllegalReferences = function (resourcesFQL) {
    ...
    var _loop_1 = function (resourceType) {
        ...
        resourcesForType.forEach(function (e) {
            resourceByName[(0, unique_naming_1.toIndexableName)(e)] = e;
        });
...
var findAllReferences = function (resourcesFQL) {
    ...
    var _loop_2 = function (referenceType) {
        var snakeCaseItem = (0, transform_1.camelToSnakeCase)(referenceType);
        ...
        for (var resourceType in resource_types_1.ResourceTypes) {
            resourcesFQL[resourceType].forEach(function (res) {
                var structures = (0, json_1.findStructure)(structure, res.fqlExpr);
                var namesAndTypes = structures.map(function (e) {
                    return {
                        type: referenceType,
                        name: e.raw[snakeCaseItem],
                        indexableName: (0, unique_naming_1.toIndexableNameFromTypeAndName)(referenceType, e.raw[snakeCaseItem]),
                        resource: res,
                    };
                });
