...
var writeMigrations = function (atChildDbPath, migrations, time) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            (0, files_1.writeNewMigration)(atChildDbPath, migrations, time);
            return [2 /*return*/];
        });
    });
};
...
var transformStatements = function (resources) {
    ...
    resources.added.forEach(function (res) {
        var _a;
        migrExprs.push((0, transform_1.toTaggedExpr)(res.target, (_a = res.target) === null || _a === void 0 ? void 0 : _a.fqlExpr, expressions_1.StatementType.Create));
    });
    resources.changed.forEach(function (res) {
        ...
        if (((_a = res.target) === null || _a === void 0 ? void 0 : _a.type) !== resource_types_1.ResourceTypes.Index && res.target) {
            migrExprs.push((0, transform_1.transformCreateToUpdate)(res.target));
        }
    });
    resources.deleted.forEach(function (res) {
        if (res.previous) {
            migrExprs.push((0, transform_1.transformCreateToDelete)(res.previous));
        }
    });
    return migrExprs;
};
