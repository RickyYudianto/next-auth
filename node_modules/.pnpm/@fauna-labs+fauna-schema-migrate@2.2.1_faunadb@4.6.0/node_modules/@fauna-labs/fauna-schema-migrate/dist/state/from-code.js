        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    p = paths[i];
                    return [4 /*yield*/, (0, files_1.loadFqlSnippet)(p)];
                case 2:
                    snippet = _a.sent();
                    if (!snippet) {
                ...
                case 3:
                    i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, (0, exports.getSnippetsFromCode)(snippets, atChildDbPath)];
            }
        });
    });
};
...
var getSnippetsFromStrings = function (codeSnippets, atChildDbPath) {
    ...
    for (var i = 0; i < codeSnippets.length; i++) {
        var expr = (0, eval_1.evalFQLCode)(codeSnippets[i]);
        snippets.push(expr);
    }
    return (0, exports.getSnippetsFromCode)(snippets, atChildDbPath);
};
...
var getSnippetsFromCode = function (codeSnippets, atChildDbPath) {
    ...
    (0, match_1.verifyCreateStatementsOnly)(snippets);
    (0, match_1.addNamesAndTypes)(snippets);
    var byNameAndType = {};
    snippets.forEach(function (snippet) {
        var key = (0, unique_naming_1.toIndexableName)(snippet);
