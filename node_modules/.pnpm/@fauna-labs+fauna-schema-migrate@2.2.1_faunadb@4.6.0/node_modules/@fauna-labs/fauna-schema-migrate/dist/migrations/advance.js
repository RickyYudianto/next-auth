...
var retrieveDatabaseMigrationInfo = function (currentMigration, targetMigration) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, from_migration_files_1.getAllLastDatabases)(currentMigration === null || currentMigration === void 0 ? void 0 : currentMigration.timestamp, false)];
            case 1:
                allCurrentMigrationChildDbs = _a.sent();
                return [4 /*yield*/, (0, from_migration_files_1.getAllLastDatabases)(targetMigration, false)
                    // They should be sorted according to the length of the child db path.
                ];
            case 2:
                allTargetMigrationChildDbs = _a.sent();
                return [4 /*yield*/, (0, diff_1.retrieveDatabasesDiff)(allCurrentMigrationChildDbs, allTargetMigrationChildDbs)];
            case 3:
                dbDiff = _a.sent();
...
var retrieveMigrationInfo = function (client, atChildDbPath) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, from_cloud_1.retrieveAllCloudMigrations)(client)];
                case 1:
                    allCloudMigrations = _a.sent();
                    return [4 /*yield*/, (0, files_1.retrieveAllMigrations)(atChildDbPath)];
                case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, from_migration_files_1.getLastMigrationSnippets)(atChildDbPath, targetMigration)];
            case 2:
                toApplyMigrations = (_a.sent()).migrations;
                diff = (0, diff_1.diffSnippets)(appliedMigrations, toApplyMigrations);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, from_migration_files_1.getLastMigrationSnippets)(atChildDbPath, currentMigration.timestamp)];
            case 1:
...
var generateApplyQuery = function (expressions, skippedMigrations, targetMigration, migrationCollection) {
    ...
    var letQueryObject = (0, generate_query_1.generateMigrationLetObject)(expressions);
...
var fixUpdates = function (expressions) {
    return expressions.map(function (e) {
        if (e.statement === expressions_1.StatementType.Update) {
            return (0, transform_1.transformUpdateToUpdate)(e);
        }
        else {
            return e;
        }
