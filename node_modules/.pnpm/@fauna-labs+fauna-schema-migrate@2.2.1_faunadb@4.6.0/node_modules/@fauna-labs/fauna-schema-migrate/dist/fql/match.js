...
var isCreateFqlExpressionOfType = function (snippet, resType) {
    var stringResType = 'create_' + (0, transform_1.camelToSnakeCase)(resType);
    if (Object.keys(snippet.fqlExpr.raw).includes(stringResType)) {
        ...
        return {
            jsonData: (0, transform_1.getJsonData)(snippet.fqlExpr, resType, expressions_1.StatementType.Create),
...
var isUpdateFqlExpressionOfType = function (snippet, resType) {
    var stringResType = (0, transform_1.camelToSnakeCase)(resType);
    if (snippet.fqlExpr.raw.update && Object.keys(snippet.fqlExpr.raw.update.raw).includes(stringResType)) {
        return {
            jsonData: (0, transform_1.getJsonData)(snippet.fqlExpr, resType, expressions_1.StatementType.Update),
