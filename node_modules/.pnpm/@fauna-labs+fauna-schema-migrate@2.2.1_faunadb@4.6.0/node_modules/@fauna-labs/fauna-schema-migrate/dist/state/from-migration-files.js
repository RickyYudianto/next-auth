...
var getAllLastDatabases = function (before, ignoreChildDb) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, exports.getLastMigrationSnippets)([], before, ignoreChildDb)];
                case 1:
                    snippets = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    childDbName = _a.sent();
                    pathsAndFiles = [];
                    return [4 /*yield*/, (0, files_1.retrieveLastMigrationVersionAndPathsForMigrationBefore)(atChildDbPath, before, ignoreChildDb)];
                case 2:
                            ...
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, Promise.all(pathAndfile.files.map(function (f) { return __awaiter(void 0, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, (0, files_1.loadFqlSnippet)(f)];
                                                    case 1:
                                                        snippet = _a.sent();
                                                        return [2 /*return*/, {
                                                                fqlExpr: snippet,
                                                                ...
                                                                previousVersions: [],
                                                                db: (0, files_1.filePathToDatabase)(childDbName, f),
                                                            }];
                                                }
                                            });
                                        }); }))];
                ...
                case 6:
                    ...
                    pathsAndExpressions.forEach(function (pathAndExpressions) {
                        (0, match_1.addNamesAndTypes)(pathAndExpressions.expressions);
                        pathAndExpressions.expressions.forEach(function (expr) {
                            var key = (0, unique_naming_1.toIndexableNameWithDb)(expr);
