    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, plan_1.planDatabaseMigrations)()
                    // Migrate the root db
                ];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                (0, shell_1.printMessage)("\uD83E\uDDEC ".concat(dbName, " Planning Migrations"));
                return [4 /*yield*/, (0, plan_1.planMigrations)(atChildDbPath, dbExprs)];
            case 1:
                planned = _a.sent();
                (0, shell_1.printMessage)("\u2714 ".concat(dbName, " Planned Migrations"), 'success');
                (0, shell_1.printMessage)("\u2699\uFE0F ".concat(dbName, " Generating Migrations"));
                return [4 /*yield*/, (0, generate_migration_1.generateMigrations)(planned)];
            case 2:
                migrations = _a.sent();
                (0, shell_1.printMessage)("\u2714 ".concat(dbName, " Generated Migrations"), 'success');
                if (!(migrations.length === 0)) return [3 /*break*/, 3];
                (0, shell_1.printMessage)("! There is no difference, nothing to write", 'info');
                return [3 /*break*/, 5];
            case 3:
                (0, shell_1.printChangeTable)(planned);
                return [4 /*yield*/, (0, generate_migration_1.writeMigrations)(atChildDbPath, migrations, time)];
            case 4:
                _a.sent();
                (0, shell_1.printMessage)("\u2714 ".concat(dbName, " Written migrations"), 'success');
                _a.label = 5;
