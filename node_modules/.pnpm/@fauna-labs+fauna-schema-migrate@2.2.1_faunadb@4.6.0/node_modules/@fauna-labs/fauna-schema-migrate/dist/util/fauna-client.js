            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        client = false;
                        if (!!secret) return [3 /*break*/, 1];
                        (0, shell_1.requestAdminKey)();
                        return [3 /*break*/, 7];
                    case 1:
                        if (!(!this.faunaClients || reinit)) return [3 /*break*/, 3];
                        _a = this;
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, getDatabaseClient(database, this.faunaClients)];
                    case 5:
                        client = _b.sent();
                        _b.label = 6;
                    case 6:
                        if (!client) {
                            throw new Error("Requested database that was not initialised ".concat(database));
                        }
                        else {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!process.env.FAUNA_CHILD_DB) return [3 /*break*/, 3];
            ...
            case 3:
                ...
                _a.label = 4;
            case 4:
                if (!(_i < resourcePaths_1.length)) return [3 /*break*/, 7];
            ...
            case 6:
                _i++;
                return [3 /*break*/, 4];
            case 7: return [2 /*return*/, faunaClients];
        }
    });
}); };
