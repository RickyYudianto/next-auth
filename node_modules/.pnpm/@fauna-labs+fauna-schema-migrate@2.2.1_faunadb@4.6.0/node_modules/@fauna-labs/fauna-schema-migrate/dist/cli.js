...
tasks_1.tasks.forEach(function (task) {
    commander_1.default
        .command("".concat(task.name).concat(task.options ? ' ' + task.options : ''))
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, tasks_1.runTask.apply(void 0, __spreadArray([task, task.name === 'run'], params, false))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
...
commander_1.default.on('command:*', function (operands) {
    ...
    (0, shell_1.printMessage)("! Unknown command '".concat(operands[0], "'"), "info");
    console.log((0, boxen_1.default)(commander_1.default.helpInformation(), {
        title: (0, kleur_1.bold)().red().bgCyan('Help Menu'),
